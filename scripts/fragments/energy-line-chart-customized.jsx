  ...
  const EnergyLineChart = React.memo(({ title, data, colors = ['#e57373', '#64b5f6', '#81c784', '#ffd54f'], onEmail, onDownload, isLoading = false, legendSeriesName }) => {
    const exportControl = (
      <>
        <button
