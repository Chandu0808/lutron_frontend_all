...
const AREA_SETTINGS_BLUE = "#1E74C5";
const AREA_SETTINGS_SECTION_BG = "#f5f7fb";

/** Typography / buttons aligned with heatmap right panel (`HeatMap.jsx` status sidebar) */
const ASD_DIALOG_TITLE_SX = {
  fontWeight: 700,
...
const ASD_SECTION_TITLE_SX = {
  ...
  color: AREA_SETTINGS_BLUE,
  lineHeight: 1.2,
};
const asdSceneStyleOccupancySx = (isSelected) => ({
  borderRadius: 1,
  ...
  minWidth: 0,
  boxShadow: 0,
  bgcolor: isSelected ? AREA_SETTINGS_BLUE : "#fff",
  color: isSelected ? "#fff" : AREA_SETTINGS_BLUE,
  border: `1px solid ${AREA_SETTINGS_BLUE}`,
  "&:hover": {
    bgcolor: isSelected ? AREA_SETTINGS_BLUE : "rgba(30,116,197,0.08)",
  },
});
...
/** Matches `EmailServer.jsx` Cancel / primary Save (settings forms). */
const ASD_SETTINGS_FORM_CANCEL_BTN_SX = {
  textTransform: "none",
  backgroundColor: "#fff",
  color: "#1565C0",
  borderColor: "#1565C0",
...
export default function AreaSettingsDialog({ open, onClose, areaId, canUpdateAreaStatus, canModifyDeviceSettings, canViewAreaSettings, canEditScene, currentUserRole, userProfile, selectedFloorId }) {
  ...
  const contentColorForChrome = appTheme?.application_theme?.content || "rgba(128, 120, 100, 0.7)";
  ...
  return (
    <Dialog 
      ...
      PaperProps={{ 
        sx: { 
          borderRadius: 1,
          bgcolor: "#fff",
          border: `2px solid ${AREA_SETTINGS_BLUE}`,
          p: 0,
          position: 'relative',
          display: 'flex',
    ...
    >
      ...
      <DialogContent sx={{ p: "12px 12px 0 12px", bgcolor: "#fff", flex: 1, minHeight: 0, overflowY: 'auto' }}>
        ...
        {loading || !areaSettings ? (
          ...
          <>
            ...
            {buttoncode && (
            <Box sx={{ bgcolor: AREA_SETTINGS_SECTION_BG, border: `2px solid ${AREA_SETTINGS_BLUE}`, borderRadius: 0, p: "8px 12px", mb: 1, display: "flex", alignItems: "center", gap: 1, minHeight: 38, width: "100%" }}>
              <Box sx={{ flex: 1 }}>
                <Typography sx={{ ...ASD_SECTION_TITLE_SX, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", mb: 0, mt: 0 }}>
                  Device Settings
                </Typography>
              </Box>
            ...
            {/* Edit Occupancy */}
            <Box sx={{ bgcolor: AREA_SETTINGS_SECTION_BG, border: `2px solid ${AREA_SETTINGS_BLUE}`, borderRadius: 0, p: "12px 12px", mb: 2 }}>
              <Typography sx={{ ...ASD_SECTION_TITLE_SX, mb: 1 }}>Edit Occupancy</Typography>
              {canModifyDeviceSettings ? (
                  ...
                  {modeOptions.map(opt => {
                    ...
                    return (
                      <Button
                        ...
                        sx={asdSceneStyleOccupancySx(isSelected)}
                      >
                        {opt}
                      </Button>
                    );
                ...
                <Box sx={{ 
                  ...
                  <Typography sx={{ color: "#111", fontSize: { xs: 11, md: 13 }, fontWeight: "normal", textAlign: 'center' }}>
            ...
            {/* Edit Scene */}
            <Box sx={{ bgcolor: AREA_SETTINGS_SECTION_BG, border: `2px solid ${AREA_SETTINGS_BLUE}`, borderRadius: 0, p: "12px 12px" }}>
              <Typography sx={{ ...ASD_SECTION_TITLE_SX, mb: 1 }}>Edit Scene</Typography>
              <Select
                fullWidth
            ...
            {isSuperAdmin && (
              <Box sx={{ bgcolor: AREA_SETTINGS_SECTION_BG, border: `2px solid ${AREA_SETTINGS_BLUE}`, borderRadius: 0, p: "12px 12px", mt: 1 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.75, mb: 1 }}>
                  <Typography sx={{ ...ASD_SECTION_TITLE_SX, mb: 0 }}>Tuning Settings</Typography>
                  <TuningSettingsHeaderIcon />
                </Box>
                  ...
                  <>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <Typography sx={{ ...ASD_SECTION_TITLE_SX, color: "#111" }}>
                          High End Trim
                        </Typography>
                        <OutlinedInput
                          ...
                          sx={{
                            ...
                            borderRadius: 1,
                            "& .MuiOutlinedInput-notchedOutline": { borderColor: "#ddd" },
                            "& input": { textAlign: "center", fontSize: ASD_SELECT_INPUT_FS, py: 0.6 },
                          }}
                        />
                      </Box>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "flex-end", mt: 1.5 }}>
                      <Button
                        ...
                        sx={{
                          textTransform: "none",
                          backgroundColor: settingsFormActionBlue,
                          color: "#fff",
                          fontSize: { xs: 10, sm: 11, md: 12 },
                          fontWeight: 400,
                          px: { xs: 1.5, md: 2 },
                          py: { xs: 0.3, md: 0.5 },
                          "&:hover": { backgroundColor: settingsFormActionBlue },
                          "&.Mui-disabled": { background: "#666 !important", color: "#fff" },
                        }}
      ...
      <DialogActions sx={{ p: "6px 18px", flexShrink: 0 }}>
        <Button
          variant="outlined"
          onClick={onClose}
          sx={{
...
function ZoneControlCard({ zone, values, onChange, disabled, isMobile, isTablet, isDesktop, isLargeScreen, is1440Screen, isUltraWide, is2560Screen, backgroundColor, contentColor, buttonColor }) {
  ...
  if (isSwitchType) {
    ...
    return (
      <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 1, mb: 0.5, ...ZONE_CONTROL_CARD_WIDTH_SX }}>
        <Typography fontWeight="bold" fontSize={{ xs: 11, md: 13 }} sx={{ flex: 1, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', mr: 1 }}>
          {zone.name}
        </Typography>
        <Box
  ...
  if (isWhitetuneType) {
    ...
    return (
      <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', gap: 1, mb: 0.5, width: '100%' }}>
        <Box sx={{
          flex: 1,
          minWidth: 0,
          bgcolor: '#fff',
