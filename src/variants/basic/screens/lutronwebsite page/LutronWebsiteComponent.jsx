...
/** Shared Project tab info cards (About, Location, Area). */
const PROJECT_INFO_CARD_SX = {
  p: 3,
  borderRadius: 1,
...
const LutronWebsiteComponent = () => {
  ...
  /** Matches main nav ribbon / `/lutron` panel when light theme is active */
  const modeToggleBlue = '#1E74C5';
  const modeTogglePaperBg = isDefaultWhiteTheme ? modeToggleBlue : '#5b5342';
  /** Slightly darker than the rail so inactive pills stay visible (white selected chip reads like image 1). */
  const modeToggleInactiveBg = isDefaultWhiteTheme
    ? darken(modeToggleBlue, 0.14)
    : buttonColor;
  /** Project-mode “Installed Solutions” sits on light surfaces when light theme — avoid white-on-white */
  const solutionsSectionHeadingColor = isDefaultWhiteTheme ? 'rgba(0, 0, 0, 0.87)' : '#fff';
  const solutionsSectionMutedColor = isDefaultWhiteTheme ? 'rgba(0, 0, 0, 0.58)' : 'rgba(255, 255, 255, 0.7)';
  ...
  return (
    <Box className="lutron-website-container" sx={{ 
      ...
      >
        ...
        <Paper
          ...
          sx={{
            ...
            justifyContent: 'center',
            alignItems: 'center',
            backgroundColor: modeTogglePaperBg,
        ...
        >
          {getDynamicModes().map((mode) => {
            ...
            const selectedBorderColor = isDefaultWhiteTheme ? modeToggleBlue : buttonColor;
            const inactiveHoverBg = isDefaultWhiteTheme
              ? darken(modeToggleInactiveBg, 0.1)
              : darken(buttonColor, 0.12);
            const isSelected = displayMode === mode.key;
            ...
            return (
              <Button
                ...
                sx={{
                  ...
                  backgroundColor: isSelected ? '#fff' : modeToggleInactiveBg,
                  color: isSelected
                    ? (isDefaultWhiteTheme ? modeToggleBlue : buttonColor)
                    : '#fff',
                  /* Match first screenshot: pill ends are semicircles (same as original `50%` style). */
                  borderRadius: '50%',
                  fontWeight: 'bold',
                  ...
                  boxShadow: 'none',
                  ...(isSelected && isDefaultWhiteTheme
                    ? { boxShadow: '0 1px 4px rgba(0,0,0,0.22)' }
                    : {}),
                  '&:hover': {
                    backgroundColor: isSelected ? '#f5f5f5' : inactiveHoverBg,
                    transform: 'translateY(-1px)',
                    boxShadow: isSelected && isDefaultWhiteTheme ? '0 2px 6px rgba(0,0,0,0.24)' : 'none',
                  },
                }}
              >
                {mode.label}
      ...
      {displayMode === 'Project' ? (
        ...
        >
          {/* About — same card pattern as Location / Area */}
          <Paper
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <IoInformationCircleOutline
                fontSize="large"
                style={isDefaultWhiteTheme ? { color: modeToggleBlue } : undefined}
                aria-hidden
              />
              <Typography
                sx={{
          ...
          <Box sx={{ 
                ...
                {(locationLink || location) && (
                  <Link
                    ...
                    sx={{
                      ...
                      cursor: 'pointer',
                      color: isDefaultWhiteTheme ? modeToggleBlue : undefined,
                    }}
                  >
                    Open Maps →
                  </Link>
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    mt: 2,
                    display: 'inline-block',
                    color: isDefaultWhiteTheme ? modeToggleBlue : 'black',
            ...
            <Typography
              sx={{
                color: solutionsSectionHeadingColor,
                fontSize: CARD_TEXT_SIZES,
                fontWeight: 600,
              }}
            >
            ...
            <Box sx={{ 
              ...
              {installedSolutions.length > 0 ? (
                ...
                <Box sx={{
                  ...
                  <Typography
                    sx={{
                      color: solutionsSectionMutedColor,
                      fontSize: CARD_TEXT_SIZES,
                      fontStyle: 'italic',
                    }}
                  >
