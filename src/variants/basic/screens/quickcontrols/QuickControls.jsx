      ...
      {detailsOpen && (selectedControl || editableControl) && (
        ...
        >
          ...
          <table style={{ width: '100%', color: '#fff', marginBottom: 32, borderCollapse: 'collapse' }}>
            <thead>
              <tr>
                <th style={{ textAlign: 'left', borderBottom: whiteChrome ? '1px solid rgba(255,255,255,0.35)' : '1px solid #fff', background: whiteChrome ? '#1565C0' : 'transparent', color: '#fff', padding: '10px 12px', fontWeight: 700 }}>Location</th>
                <th style={{ textAlign: 'left', borderBottom: whiteChrome ? '1px solid rgba(255,255,255,0.35)' : '1px solid #fff', background: whiteChrome ? '#1565C0' : 'transparent', color: '#fff', padding: '10px 12px', fontWeight: 700 }}>Action</th>
                {editMode && <th style={{ textAlign: 'left', borderBottom: whiteChrome ? '1px solid rgba(255,255,255,0.35)' : '1px solid #fff', background: whiteChrome ? '#1565C0' : 'transparent', color: '#fff', padding: '10px 12px', fontWeight: 700 }}>
                  {hasSameActionType ? (
                    <span 
                      style={{ 
                        cursor: 'pointer', 
              ...
              <>
                <button
                  style={{
                    ...
                    opacity: updateStatus === 'loading' ? 0.85 : 1,
                  }}
                  onClick={handleSave}
            ...
            <div style={{ marginTop: 24, display: "flex", gap: 12, justifyContent: "flex-end" }}>
              <button
                ...
                style={{
                  padding: "10px 28px",
                  borderRadius: 8,
                  border: (selectedActionData && selectedActionData.type) ? "1px solid #1565C0" : "1px solid #888",
                  background: (selectedActionData && selectedActionData.type) ? ACTION_BLUE : "#888",
                  color: "#fff",
                  fontWeight: 500,
