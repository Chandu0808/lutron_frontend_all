  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchAlertsDisplayStatus.pending, (state) => {
        state.error = null;
        // Only blank the page with the spinner on initial load. Refetches after a toggle
        // should update toggles in place without hiding the list (avoids "reload" flash).
