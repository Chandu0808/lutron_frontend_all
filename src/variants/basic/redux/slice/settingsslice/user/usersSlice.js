...
// Thunk to update user with Bearer token
export const updateUser = createAsyncThunk(
  ...
  async ({ userId, body }, { rejectWithValue }) => {
    ...
    try {
      // Backend conventions in this repo: POST for delete (/users/delete?user_id=)
      // Use PATCH for partial user updates.
      const response = await BaseUrl.patch(`/users/update?user_id=${userId}`, body, {
        headers: { Authorization: `Bearer ${token}` },
      });
