...
const colorsMatch = (a, b) => normalizeColor(a) === normalizeColor(b);

/** Bottom preset row — index 3 (4th swatch) is default white for theme Reset. */
export const HEX_PICKER_PRESET_SWATCHES = [
    '#000000',
    '#4d4d4d',
    '#808080',
    '#ffffff',
                ...
                hexes.push(
                    ...
                    >
                        <polygon
                            ...
                            fill={color}
                            stroke={colorsMatch(color, selectedColor) ? '#000' : '#fff'}
                ...
                {HEX_PICKER_PRESET_SWATCHES.map((color, i) => (
                    ...
                    >
                        <polygon
                            ...
                            fill={color}
                            stroke={colorsMatch(color, selectedColor) ? '#000' : '#ccc'}
                            strokeWidth={colorsMatch(color, selectedColor) ? 2 : 1}
                            className="hex"
                        />
                    </svg>
