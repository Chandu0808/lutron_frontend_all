...
const UpdateAreaGroup = () => {
    ...
    const handleSave = () => {
        ...
        const payload = {
            name: groupName,
            special: role === "Superadmin" ? true : false,
    ...
    return (
        <Box className="area-group-container" sx={{
            ...
            boxSizing: 'border-box'
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', mb: 3, flexShrink: 0 }}>
                        ...
                        {canModifyAreaGroup() && isEditing && (
                            <Button
                                ...
                                sx={{
                                    border: '1px solid var(--area-groups-border, grey)',
                                    textTransform: 'none',
                                    p: 1,
                                    mt: 3,
                ...
                {/* Delete Area Group Confirmation Dialog */}
                <ConfirmDialog
                ...
                {/* Delete Individual Area Confirmation Dialog */}
                <ConfirmDialog
...
export default UpdateAreaGroup