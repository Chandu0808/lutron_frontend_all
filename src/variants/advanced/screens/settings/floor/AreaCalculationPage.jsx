  ...
  return (
    <Box sx={{ p: 3, maxWidth: '100%', minHeight: '100vh' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 3, gap: 2 }}>
        ...
        <Typography variant="h4" sx={floorToolPageTitleSx}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={6}>
          ...
          >
            <Typography variant="h6" sx={{ p: 2, ...floorToolPageTitleSx, textAlign: 'center', borderBottom: '1px solid #e0e0e0' }}>
              Select an Area here
            </Typography>
            {/* Debug info */}
        ...
        <Grid item xs={12} lg={6}>
          <Paper sx={{
            ...
            {calculationResults ? (
              ...
              <Box>
                <Typography variant="subtitle1" sx={{ mb: 2, ...floorToolLabelSx, textAlign: 'center' }}>
                ...
                {selectedEdge && (
                  <Box sx={{ mt: 2 }}>
                    {/* Edge Length Input */}
                    <Box sx={{ mb: 3 }}>
                      <Typography variant="body2" sx={{ mb: 1, ...floorToolLabelSx, textAlign: 'center' }}>
                        Enter Edge Length:
                      </Typography>
                      <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-end' }}>
                        <TextField
                          ...
                          size="small"
                          sx={{ flexGrow: 1, ...floorToolTextFieldSx }}
                        ...
                        <FormControl size="small" sx={{ minWidth: 100 }}>
                          <InputLabel sx={floorToolInputLabelSx}>Unit</InputLabel>
                          <Select
                            value={lengthUnit}
