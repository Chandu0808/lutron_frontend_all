...
import { isGoldApplicationTheme } from "../../../utils/themeOnSurface";
import {
  getThemeButtonColor,
...
const FOFPComponent = () => {
  ...
  const useLightChrome = isDefaultWhiteTheme || isGoldTheme || isTheme4Page;
    ...
    <SettingsLayout>
      ...
      >
        ...
        >
          ...
          >
            <FormControl size="small" className="fofp-floor-select-field" sx={{ minWidth: { xs: "100%", md: 240 }, backgroundColor: 'var(--users-input-bg, #fff)', borderRadius: 1 }}>
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          sx: {
            background: "var(--settings-theme-dialog-bg, var(--area-picker-light-dialog-bg, #faf0d4))",
        ...
        <DialogTitle
          sx={{
            color: isTheme4Page
              ...
              : "var(--settings-panel-text, #2c2820)",
          }}
        >
          Generate FOFP layout?
        </DialogTitle>
        <DialogContent>
          <Typography
            variant="body2"
            sx={{
              color: isTheme4Page
                ...
                : "var(--settings-panel-muted-text, rgba(44, 40, 32, 0.72))",
            }}
          >
