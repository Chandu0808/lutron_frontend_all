...
const HeatmapControls = () => {
  ...
  // (e.g. Dashboard → Floorplan). The old "floorsChanged" ref gate skipped that
          ...
          >
            {HEATMAP_MODE_KEYS.map((mode) => (
              <Button
                ...
                className={`heatmap-mode-tab-btn${displayMode === mode ? ' heatmap-mode-tab-btn-active' : ''}`}
                role="tab"
