...
const ProcessorsSettings = () => {
  ...
  const { rowSx: processorsHeaderRowSx, cellSx: processorsTableHeaderSx } =
  ...
  return (
    <Box className="help-container" sx={{ position: 'relative', ...settingsHelpLayoutShellSx }}>
      {pageBusy && (
        <Box
          sx={{
            position: 'fixed',
              ...
              {!listLoading && !listAllError && processorsListAll.length > 0 && (
                ...
                >
                  <Table size="small" sx={{ minWidth: 720 }}>
                    <TableHead>
                      <TableRow sx={processorsHeaderRowSx}>
