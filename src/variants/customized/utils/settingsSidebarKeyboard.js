...
import { isCustomizedSettingsAppRoute } from "./customizedSettingsPaths";

/**
 * Customized variant settings sidebar keyboard — recognizes `/setting/*` routes.
 */
const api = {
  navItemKeys: [],
  navItems: [],
...
function handleSettingsSidebarWindowKeyDown(event) {
  if (!isCustomizedSettingsAppRoute(api.pathname)) return;
