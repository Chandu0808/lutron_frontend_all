...
export function createFloorModule({
  ...
  //   }
  // });
  const createAreaGroup = createAsyncThunk(
    'area_group/create',
  ...
  const updateFloor = createAsyncThunk(
    'floors/updateFloor',
  ...
  // Delete Floor
  const deleteFloor = createAsyncThunk(
    'floors/deleteFloor',
  ...
  // Fetch Light Status
  const fetchLightStatus = createAsyncThunk(
  ...
  const fetchOccupancyStatus = createAsyncThunk(
  ...
  // Fetch Energy Status
  const fetchEnergyStatus = createAsyncThunk(
  ...
  //fetch single floor
  const fetchSingleFloor = createAsyncThunk(
  ...
  const updateAreaFloorAndProcessor = createAsyncThunk(
  ...
  const createFloorWithAreas = createAsyncThunk(
  ...
  const correctCoordinates = createAsyncThunk(
  ...
  const calculateAreaWithReferenceLength = createAsyncThunk(
  ...
  const fetchExistingCalculatedAreas = createAsyncThunk(
  ...
  const reducer = floorSlice.reducer;
  return {
    reducer,
    fetchFloors,
    setFloorSortMode,
